        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Historial de Citas</p>
    ...
    if($_GET){
        ...
        if($action=='booking-added'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                    <br><br>
                        <h2>¡Su cita ha sido agendada exitosamente!</h2>
                        <a class="close" href="appointment.php">&times;</a>
                        <div class="content">
                        Su número de cita es: '.$id.'.<br><br>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a class="close" href="appointment.php">&times;</a>
                        <div class="content">
                            ¿Seguro que quiere cancelar esta cita?<br><br>
                            Nombre de la Sesión: &nbsp;<b>'.substr($title,0,40).'</b><br>
                            Nombre del Doctor: &nbsp;<b>'.substr($docname,0,40).'</b><br><br>
