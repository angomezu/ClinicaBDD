                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p> Aquí puede dar seguimiento al historial de sus pasadas y futuras citas.<br>También, consulte la hora de Inicio de las Sesiones de sus Doctores de preferencia.<br><br>
                                ¿Aún no sabes con cuál Doctor agendar una cita? ¡No te preocupes! <br><br>
                                Puedes ver el perfil de cada Doctor en la Clinica aquí:
                                <a href="doctors.php" class="non-style-link"><b>Ver Doctores</b></a> <br>
                                o puedes buscar sesiones de distintos doctores según la especialidad aquí:
                                <a href="schedule.php" class="non-style-link"><b>Ver Sesiones</b> </a>
                            </p>
                            
                            <h3>Busque a un Doctor aquí</h3>
                            <form action="schedule.php" method="post" style="display: flex">

                                <input type="search" name="search" class="input-text " placeholder="Busque al Doctor y encontraremos la Sesión disponible" list="doctors" style="width:45%;">&nbsp;&nbsp;
                        ...
                        <table border="0" width="100%"">
                            <tr>
                                <td width="50%">
                                    ...
                                    <center>
                                        <table class="filter-container" style="border: none;" border="0">
                                            <tr>
                                                <td colspan="4">
                                                    <p style="font-size: 20px;font-weight:600;padding-left: 12px;">Estados</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 25%;">
                                                ...
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:100%;display: flex;padding-top:21px;padding-bottom:21px;">
                                                        <div>
                                                                <div class="h1-dashboard">
                                ...
                                <td>
                                    ...
                                    <p style="font-size: 20px;font-weight:600;padding-left: 40px;" class="anime">Tus Citas Agendadas</p>
                                    <center>
