...
<?php 
$con=mysqli_connect("localhost","root","clinicaBDD2022$","myhmsdb");
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Clinica La Bendición de Dios </a>
...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%; padding-bottom: 20px;font-family: 'IBM Plex Sans', sans-serif;"> BIENVENIDO ADMIN </h3>
    <div class="row">
  <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      <a class="list-group-item list-group-item-action active" id="list-dash-list" data-toggle="list" href="#list-dash" role="tab" aria-controls="home">Dashboard</a>
      <a class="list-group-item list-group-item-action" href="#list-doc" id="list-doc-list"  role="tab"    aria-controls="home" data-toggle="list">Lista de Doctores</a>
      ...
      <a class="list-group-item list-group-item-action" href="#list-app" id="list-app-list"  role="tab" data-toggle="list" aria-controls="home">Lista de Citas</a>
      <!-- <a class="list-group-item list-group-item-action" href="#list-pres" id="list-pres-list"  role="tab" data-toggle="list" aria-controls="home">List de Prescripciones</a>
     <a class="list-group-item list-group-item-action" href="#list-settings" id="list-adoc-list"  role="tab" data-toggle="list" aria-controls="home">Añadir Doctor</a>
               ...
               <div class="col-sm-4">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;">Lista de Doctores</h4>
                      <script>
                ...
                <div class="col-sm-4">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;">Lista de Citas</h4>
                ...
                <div class="col-sm-4" style="left: 13%;margin-top: 5%;">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <!--<h4 class="StepTitle" style="margin-top: 5%;">Lista de Prescripciones</h4>
...
<!----------------------------------------------- LISTAR DOCTORES-------------------------------------------------------------->
      ...
      <form class="form-group" action="doctorsearch.php" method="post">
        <div class="row">
        <div class="col-md-10"><input type="text" name="doctor_contact" placeholder="Ingresar Email" class = "form-control"></div>
...
<div class="tab-pane fade" id="list-pat" role="tabpanel" aria-labelledby="list-pat-list">
      ...
      <form class="form-group" action="patientsearch.php" method="post">
        <div class="row">
        <div class="col-md-10"><input type="text" name="patient_contact" placeholder="Ingrese Número de Teléfono" class = "form-control"></div>
        <div class="col-md-2"><input type="submit" name="patient_search_submit" class="btn btn-primary" value="Buscar"></div></div>
      </form>
    </div>
    <a class="btn btn-primary" href="createpatient.php">Agregar Nuevo Paciente</a>
    <table class="table">
        <thead>
			<tr>
				<th>ID Paciente</th>
        ...
        <tbody>
			...
			while($row = $result->fetch_assoc()) {
                ...
                <tr>
                    ...
                    <td>$row[created_at]</td>
                    <td>
                        <a type='button' class='btn btn-primary' href='editpatient.php?id=$row[id]'>Editar</a>
                        <a type='button' class='btn btn-danger' href='deletepatient.php?id=$row[id]'>Borrar</a>
                </td>
                </tr>";
            }
...
<!-------------------------------------- LISTAR AÑADIR, ELIMINAR DOCTORES & MENSAJES -------------------------------------------
