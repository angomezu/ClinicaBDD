...
?>
                ...
                <tr >
                    <td colspan="2" style="padding-top:30px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">Añadir un nuevo Doctor</p>
                    </td>
                    <td colspan="2">
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                        ¿Está seguro que quiere borrar este dato?<br>('.substr($nameget,0,40).').
