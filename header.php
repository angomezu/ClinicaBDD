        ...
        <a href="index.php"></a>
          ...
          <?php
                  if (isset($_SESSION["useruid"])) {
                    ...
                    echo "<li class='nav-item cta'><a href ='signup.php' class='nav-link'><span>Registrarse</span></a></li>";
      ...
      <div class="row no-gutters">
        ...
        <div class="col-md-6 color-3 p-4">
          ...
          <form action="#" class="appointment-form">
            ...
            <div id="servicios" class="form-group">
        ...
        <div class="col-md-3 ftco-animate">
          <div class="pricing-entry pb-5 text-center">
            <div>
              ...
              <p><span class="price">$10.00</span> <span class="per">/ consulta</span></p>
            </div>
            <ul>
              <li>Dolores</li>
              <li>Infecciones</li>
            ...
            <p class="button text-center"><a href="#" class="btn btn-primary btn-outline-primary px-4 py-3"
                data-toggle="modal" data-target="#modalRequest">Hacer Cita</a></p>
          </div>
        </div>
        <div class="col-md-3 ftco-animate">
          <div class="pricing-entry pb-5 text-center">
            <div>
              ...
              <p><span class="price">$20.00</span> <span class="per">/ consulta</span></p>
            </div>
            <ul>
