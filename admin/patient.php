        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <a href="patient.php" ><button  class="login-btn btn-primary-soft btn btn-icon-back"  style="padding-top:11px;padding-bottom:11px;margin-left:20px;width:125px"><font class="tn-in-text">Atrá<samp></samp></font></button></a>
...
?>
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Total de pacientes:  <?php echo $list11->num_rows; ?></p>
                    </td>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        echo     '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="symptoms" class="input-text" min="0"  placeholder="Inserte síntomas" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="diagnosis" class="input-text" min="0"  placeholder="Inserte diagnóstico" required><br>
                                </td>
                            </tr>
                            <tr>
                            <td class="label-td" colspan="2">
                                <input type="text" name="prescription" class="input-text" min="0"  placeholder="Inserte receta" required><br>
                            </td>
                        </tr>
                            <tr>
                                <td class="label-td" colspan="2">
